...
@section('content')
                    ...
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-sm-10 col-lg-8">
                                ...
                                <h1 class="display-3 text-white animated slideInDown">The Best Online <br> Learning Platform</h1>
                                <p class="fs-5 text-white mb-4 pb-2">Learnin Today! Leading Tomorrow! </p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="owl-carousel-item position-relative">
                ...
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(24, 29, 56, .7);">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-sm-10 col-lg-8">
                                <h5 class="text-primary text-uppercase mb-3 animated slideInDown">Category 1</h5>
                                <h1 class="display-3 text-white animated slideInDown">Web Design</h1>
                                <p class="fs-5 text-white mb-4 pb-2">If You love creating beautiful designs.<br> If you want to start your career as a web developer,<br> you can join this course!</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="owl-carousel-item position-relative">
                ...
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(24, 29, 56, .7);">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-sm-10 col-lg-8">
                                <h5 class="text-primary text-uppercase mb-3 animated slideInDown">Category 2</h5>
                                <h1 class="display-3 text-white animated slideInDown">Graphic Design</h1>
                                <p class="fs-5 text-white mb-4 pb-2">If You love creating beautiful designs.<br> If you want to start your career as a graphic designer,<br> you can join this course!</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="owl-carousel-item position-relative">
                ...
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(24, 29, 56, .7);">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-sm-10 col-lg-8">
                                <h5 class="text-primary text-uppercase mb-3 animated slideInDown">Category 3</h5>
                                <h1 class="display-3 text-white animated slideInDown">Video Editing</h1>
                                <p class="fs-5 text-white mb-4 pb-2">If You love creating video capcut. <br>If you want to start your career as a video editor, <br>you can join this course!</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-xxl py-5 category">
        <div class="container">
            ...
            <div class="row g-3">
                <div class="col-lg-7 col-md-6 ms-5 ps-5">
                    <div class="row g-3">
                        ...
                        <div class="col-lg-6 col-md-12 wow zoomIn" data-wow-delay="0.3s">
                            <a class="position-relative d-block overflow-hidden" href="">
                                <img class="img-fluid" src="{{asset('front-assets/img/cat-2.jpg')}}" alt="">
                                <div class="bg-white text-center position-absolute bottom-0 end-0 py-2 px-3" style="margin: 1px;">
                        ...
                        <div class="col-lg-6 col-md-12 wow zoomIn" data-wow-delay="0.5s">
                            <a class="position-relative d-block overflow-hidden" href="">
                                <img class="img-fluid" src="{{asset('front-assets/img/cat-3.jpg')}}" alt="">
                                <div class="bg-white text-center position-absolute bottom-0 end-0 py-2 px-3" style="margin: 1px;">
                        ...
                        <div class="course-item bg-light">
                            <div class="position-relative overflow-hidden">
                                ...
                                <div class="w-100 d-flex justify-content-center position-absolute bottom-0 start-0 mb-4">
                                    <a href="{{route('coursedetails',$course->id)}}" class="flex-shrink-0 btn btn-sm btn-primary px-3 border-end" style="border-radius: 30px 0 0 30px;">Read More</a>
                                    <a href="{{route('joins',$course->id)}}" class="flex-shrink-0 btn btn-sm btn-primary px-3" style="border-radius: 0 30px 30px 0;">Join Now</a>
                                </div>
                            </div>
                            ...
                            <div class="d-flex border-top">
                                <small class="flex-fill text-center border-end py-2"><i class="fa fa-user-tie text-primary me-2"></i>Sr. Hein</small>
                                <small class="flex-fill text-center border-end py-2"><i class="fa fa-clock text-primary me-2"></i>1:30 hrs/day</small>
